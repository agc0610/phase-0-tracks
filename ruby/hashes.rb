# pseudocode and write a program that will allow an interior designer to enter the details of a given client:
...
:needs_childproofing => "",
:number_of_children => "",
:decor_theme => ["nautical", "vintage", "modern", "minimalist"],
:likes_matching => "",
:primary_colors_permitted => "",
:budget => ""
}
